...
def vizInputs_HiC(wildcards):
  ...
  input_dict = {'bed': bed, 'rlen': rules.combine_ont.output.ONT_len, 'interout': rules.confirm_out.output.flag, 'pos_locs':"results/{sample}/breaks/hap1_splits_pos.done" }
