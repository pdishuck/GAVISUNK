...
parser.add_argument("--gapbed", help="bed file of validation gaps")
...
for contig in contigs:
    ...
    for row in bedreg.itertuples():
        ...
        interval_df = pd.DataFrame(intervals,columns=['Start','End','Plotgroup'],)
        ...
        for pgi in [0,1]:
            ...
            #     print("overlap: ",rows_overlap)
            #     print("rows avail: ",rows_used - rows_overlap)
